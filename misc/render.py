# modified from https://github.com/zekunhao1995/PointFlowRenderer
# and refered https://github.com/tolgabirdal/Mitsuba2PointCloudRenderer
import os
import argparse
import glob
import re
...
# install mitsuba before running the render. My version Mitsuba version 2.2.1 (master[83d1b180], Ubuntu)
...
# note: inside each folder are all .ply files to be rendered. Need to change fov to adjust the size.

# color used in P2C paper.
