...
from extensions.chamfer_dist import ChamferDistanceL1, ChamferDistanceL2, PatialChamferDistanceL2
...
class Metrics(object):
    ITEMS = [{
        ...
        'name': 'UCDL2',
        'enabled': True,
        'eval_func': 'cls._get_unidirectional_chamfer_distancel2',
        'eval_object': PatialChamferDistanceL2(ignore_zeros=True),
        'is_greater_better': False,
        'init_value': 32767
    }]
    # ITEMS = [{
